...
import 'package:task_management/add_edit_note_page/ui/add_edit_note_page.dart';
import 'package:task_management/common/widgets/reusable_text.dart';
import '../../common/app_colors/app_colors.dart';
import '../../common/app_const/app_constant.dart';

class SearchNoteItemPage extends StatelessWidget {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: appStyle(11, FontWeight.w300, AppColors.kBlackColor),
                        )
                      ],
                    ),
                  ],
